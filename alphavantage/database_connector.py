...
# db = SQLite3Connector.connect('test.db')

# db.create_table('footable',
#                [{'name': 'id',
#                  'dtype': 'INTEGER',
#                  'not_null': True,
#                  'pk': True},
...
# schema = db.get_schema('footable')

# for s in schema:
#    print(s)

# db.drop_table('footable')


# print(foo.get_schema('meta2'))

# tables = foo.get_tables()

# w_columns = ('id', 'info', 'symbol', 'last_refreshed',
#             'output_size', 'timezone', 'data_table')


# values = [None, 'Time series', 'AYB', '2014-02-02',
#          'full', 'Eastern/US', 'MSFT_table']

# print(f'vals = {len(values)}')
# foo.insert('symbols_meta', w_columns, values)
# foo.commit()

# foo.insert(
# s = foo.select('symbols_meta')
